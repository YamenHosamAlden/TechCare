...
class GetMaintenanceListUsecase extends Usecase<List<Receipt>, void> {
  final ReceiptsRepository receiptsRepository;
  GetMaintenanceListUsecase({required this.receiptsRepository});

  @override
  Future<Either<Failure, List<Receipt>>> call(Void) {
    return receiptsRepository.getMaintenanceList();
  }
}
