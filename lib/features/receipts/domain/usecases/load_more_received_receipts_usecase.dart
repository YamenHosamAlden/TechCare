...
class LoadMoreReceivedReceiptsUsecase extends Usecase<List<Receipt>, void> {
  final ReceiptsRepository receiptsRepository;
  LoadMoreReceivedReceiptsUsecase({required this.receiptsRepository});

  @override
  Future<Either<Failure, List<Receipt>>> call(Void) {
    return receiptsRepository.loadMoreReceivedReceipts();
  }
}
