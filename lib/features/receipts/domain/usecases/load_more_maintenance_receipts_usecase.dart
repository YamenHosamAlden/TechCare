...
class LoadMoreMaintenanceReceiptsUsecase extends Usecase<List<Receipt>, void> {
  final ReceiptsRepository receiptsRepository;
  LoadMoreMaintenanceReceiptsUsecase({required this.receiptsRepository});

  @override
  Future<Either<Failure, List<Receipt>>> call(Void) {
    return receiptsRepository.loadMoreMaintenanceReceipts();
  }
}
