...
class LoadMoreQualityReceiptsUsecase extends Usecase<List<Receipt>, void> {
  final ReceiptsRepository receiptsRepository;
  LoadMoreQualityReceiptsUsecase({required this.receiptsRepository});

  @override
  Future<Either<Failure, List<Receipt>>> call(Void) {
    return receiptsRepository.loadMoreQualityReceipts();
  }
}
