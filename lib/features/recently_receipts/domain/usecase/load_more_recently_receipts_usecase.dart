...
class LoadMoreRecentlyReceiptsUsecase
    extends Usecase<List<ReceiptContainer>, void> {
   RecentlyReceiptsRepository recentlyReceiptsRepository;


  LoadMoreRecentlyReceiptsUsecase({required this.recentlyReceiptsRepository});

  @override
  Future<Either<Failure, List<ReceiptContainer>>> call(Void) {
    return recentlyReceiptsRepository.loadMoreRecentlyAddedReceipts();
  }
}
