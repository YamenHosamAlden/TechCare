...
class ReloadRecentlyReceiptsUsecase extends Usecase<List<ReceiptContainer>, void> {
  final RecentlyReceiptsRepository recentlyReceiptsRepository;

  ReloadRecentlyReceiptsUsecase({required this.recentlyReceiptsRepository});

  @override
  Future<Either<Failure, List<ReceiptContainer>>> call(Void) {
    return recentlyReceiptsRepository.reloadRecentlyAddedReceipts();
  }
}
