...
class RecentlyReceiptsContainer extends StatefulWidget {
  final ReceiptContainer receiptContainer;
  final ContainerDisplayType displayType;
  const RecentlyReceiptsContainer({
    super.key,
    required this.receiptContainer,
  }) : displayType = ContainerDisplayType.all;

  @override
  State<RecentlyReceiptsContainer> createState() =>
      _RecentlyReceiptsContainerState();
}

class _RecentlyReceiptsContainerState extends State<RecentlyReceiptsContainer> {
  @override
